...
class OrderPageLocators:
    ...
    DAY_VALUE = (By.XPATH, '//div[@class="react-datepicker__week"][5]//div[contains(@class, "react-datepicker__day")][1]')
    PERIOD_FIELD = (By.XPATH, '//div[@class="Dropdown-root"]//div[@class="Dropdown-control"]')
    OPTION_PERIOD_FIELD = (By.XPATH, '//div[@class="Dropdown-menu"]//div[@class="Dropdown-option"][5]')
    ...
    TEXT_IN_ORDER_STATUS_BUTTON = (By.XPATH, '//div[@class="Order_NextButton__1_rCA"]//button[@class="Button_Button__ra12g Button_Middle__1CSJM"]')
